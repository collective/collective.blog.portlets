...
class FunctionalTestCase(ptc.FunctionalTestCase, TestCase):
    ...
    def test_archive(self):
        ...
        self.assert_(pos != -1)
        pos = portlet.find('month_feb', pos)
        self.assert_(pos != -1)
        pos = portlet.find('(1)', pos)
        self.assert_(pos != -1)
        pos = portlet.find('month_may', pos)
        self.assert_(pos != -1)
        pos = portlet.find('(1)', pos)
        self.assert_(pos != -1)
        pos = portlet.find('2009', pos)                         
        self.assert_(pos != -1)
        pos = portlet.find('month_jul', pos)
        self.assert_(pos != -1)
        pos = portlet.find('(1)', pos)
        self.assert_(pos != -1)
        pos = portlet.find('2010', pos)
        self.assert_(pos != -1)
        pos = portlet.find('month_jan', pos)
        self.assert_(pos != -1)
        ...
        self.assert_(pos != -1)
        pos = portlet.find('month_mar', pos)        
        self.assert_(pos != -1)
        pos = portlet.find('(1)', pos)        
        self.assert_(pos != -1)
        pos = portlet.find('month_apr', pos)
        self.assert_(pos != -1)
        pos = portlet.find('(1)', pos)
        self.assert_(pos != -1)
        pos = portlet.find('month_may', pos)
